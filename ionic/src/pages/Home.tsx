...
import { IonTabs, IonRouterOutlet, IonTabBar, IonTabButton, IonIcon, IonLabel, IonMenu, IonHeader, IonToolbar, IonTitle,
  IonContent, IonList, IonItem, IonPage, IonAvatar, IonCard, IonCardHeader, IonCardTitle, IonCardContent, IonButton, IonCardSubtitle, IonListHeader,
  IonNote,
  IonGrid,
  IonRow,
  IonCol,
...
import { add, trash, download, settings, arrowRoundForward, calendar, locate } from 'ionicons/icons';
  ...
  return (
    <IonPage>
      ...
      <IonTabBar slot="bottom">
        <IonTabButton tab="objectifs" href="/">
          <IonIcon icon={locate} />
          <IonLabel></IonLabel>
        </IonTabButton>
